...
# Apply the transformation to a group of 3D points
def transform_points(points, roll, pitch, yaw):
    R = rotation_matrix(roll, pitch, yaw)
    transformed_points = np.dot(points, R.T)  # Apply rotation matrix to each point
